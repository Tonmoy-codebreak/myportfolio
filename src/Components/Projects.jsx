  ...
  return (
    <>
      <section id="projects" className="py-24 px-6 sm:px-10 lg:px-20">
              ...
              <div className="relative z-10">
                ...
                <ul className="text-sm text-gray-400 space-y-1 mb-4">
                  {project.features.map((feature, i) => (
                    <li
                      key={i}
                      className="before:content-['•'] before:mr-2 before:text-cyan-400"
                    >
                      {feature}
                    </li>
                  ))}
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <a
                    ...
                    className="inline-flex items-center px-4 py-2 rounded-full text-sm bg-white/10 text-white hover:bg-cyan-500/20 transition cursor-pointer"
                  >
                    Details
                  </a>
                </div>
        ...
        >
          This is just the beginning and more meaningful builds are on the way. Stay
          tuned.
        </motion.p>
      </section>
